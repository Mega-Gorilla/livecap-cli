...
| この run の session root | C:\livecap-nonascii-probe\run-20768-9082357d |
...
| git commit | 675053d8d719495a3754ae817ea9145e773b274d |
| run_id | 2026-09-15T10-14-36Z |
| 最終検証日 | 2026-09-15 |
...
| 呼び出し元 | 渡すパス | 受け側ライブラリ | wide path 対応 | 非 ASCII 実測 | 失敗の可視性 | 決定 | **実測で確定** | 粒度 | 追跡 |
|---|---|---|---|---|---|---|---|---|---|
| `livecap_cli/engines/parakeet_engine.py:471` | なし (ndarray in / ndarray out) | librosa | n/a | — 対象外 | — | 非該当 | — 対象外 | - | — |
