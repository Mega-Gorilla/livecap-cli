...
|---|---|
| WhisperS2T / Parakeet_ja / Voxtral / Canary / Parakeet 英語 / ReazonSpeech / **qwen3asr** | ✅ 自動 hallucination 抑制 (default on で active、**7 engine 対応**で PR-A 系列完成) |
