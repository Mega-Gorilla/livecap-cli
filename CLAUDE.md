...
This project is `0.3.0`. **Do not add `Optional[T] = None` "legacy mode" flags whose sole purpose is preserving pre-existing bugs.** When changing defaults or observable behavior:
