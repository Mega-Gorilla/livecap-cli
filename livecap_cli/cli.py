...
def main(argv: list[str] | None = None) -> int:
    ...
    transcribe_parser.add_argument(
        ...
        help=(
            ...
            "Parakeet (ja/en) token_confidence_mean < 0.005, "
            "Voxtral avg_logprob < -1.0 [PR-A.4.1, strict-gated: only when "
            "other signals are absent], "
            "Canary token_confidence_mean < 0.005 [PR-A.4.2, greedy decoding 経由], "
            "Parakeet 英語 token_confidence_mean < 0.005 [PR-A.4.3, "
            "preserve_alignments + confidence_cfg 経由]). "
